...
- Images for the Wars & Conflicts lane, for now (user call, 2026-08-08) — People and Events & Inventions (Discoveries) still get images; Wars & Conflicts entries won't. "Research image sourcing" was already running when this landed and has been redirected to drop the wars.json portion of its investigation.
