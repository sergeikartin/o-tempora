...
// Dumps any country Q-ID a grouped Wars/Discoveries event carries (across
// both raw sources, unioned) that isn't yet in REGION_CATEGORIES. Run
// after each batch of manual additions to region-categories.ts until this
// reports zero — except for Q-IDs that genuinely have no home in the
// app's fixed 6-region set (e.g. Oceania), which are expected to stay
// unmapped forever and resolve to "no region" by design.
//
