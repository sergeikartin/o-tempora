...
| Layer | Technology |
|---|---|
| Pipeline query layer | Wikidata Query Service (SPARQL) — Conflicts' and Milestones' per-QID enrichment (including `tagline`, live-fetched for all three lanes), People's secondary reign/tagline enrichment |
