...
- Re-run Fetch: `cd packages/data-pipeline && npm run fetch` — Pantheon (CSV download → HPI-filtered description batch) → Wikidata events, in that order. Wikidata reigns is currently unwired (ticket 19).
