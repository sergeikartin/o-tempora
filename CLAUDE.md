...
## Project Overview
Read-only, zoomable visualization of world history — People, Conflicts, and Milestones lanes, hardcoded ahead of time. No accounts, no editing, no live data fetching.
